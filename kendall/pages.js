...
function popup(popuptype){
    ...
    if (popuptype === "nixon"){
        ...
        modalparagraph.innerHTML='The photo of blurry trees at night (Benefit St) is by Eve O’Shea [eveoshea.com], who also read an early draft. The leaf border I photoshopped out of a 13th century illuminated manuscript, and the coin is Ancient Roman (Agrippina & Nero): [romancoins.info/Wives1.html]. The other icons and rug are random stock images; the sound effects are from YouTube. The pink knot is from a WikiHow article on How To Tie Celtic Knots. The gif of sparkles on water is an image someone uploaded to Reddit about their trip to Malta. Photos of Kendall, Grimes, and Sarah are IG screenshots; Lil Peep is a screenshot of the Awful Things music vid. <br><br> The other assets are from my camera roll and desktop. <br> <br>Thanks to Lucia Kan-Sperling, Libby Marrs [libbymarrs.net], and Liby Hays [libyhays.net] for reading, testing, and generally informing/inspiring the basic sensibility of this project <3.';
    }
