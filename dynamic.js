...
shortDescriptMap.set('courtdebt', "April 2019. <i>The College Hill Independent</i>: Data journalism on court debt in Rhode Island <br> <img class=\"workpic\" src=\"index_files/courtdata.jpg\"> With a team of journalists investigating the cycle of court debt in RI, I wrote a program to scrape and crunch data from files from the RI Judiciary's case portal. <button type='button' onclick='expandWorkObj('courtdebt')'>SEE MORE</button>");
